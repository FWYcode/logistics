...
<head>
    ...
    <meta name="description"
          content="火箭以互联网、信息技术和创新的力量为整个物流行业带来革命性变化，致力于打造一站式的物流和供应链服务平台，为客户提供高效的服务和体验，成为最值得信赖和尊重的物流领导者。"/>
...
<style>
    ...
    .cat-list .mcat .scat li a:hover {
        background: rgba(86, 150, 253, .9);
        color: #fff;
    }
    ...
    .nav-main #adlink .bd ul {
        width: 100%;
        height: 420px;
    }

    .nav-main #adlink .bd ul li {
        width: 100%;
        height: 420px;
    }

    .nav-main #adlink .bd li a {
        display: block;
        width: 100%;
        height: 420px;
    }
    ...
    #banner .bd .bn1 {
        background: url(${pageContext.request.contextPath}/static/images/1.jpg) no-repeat center 0;
    }

    #banner .bd .bn2 {
        background: url(${pageContext.request.contextPath}/static/images/sssss0423.jpg) no-repeat center 0;
    }

    #banner .bd .bn3 {
        background: url(${pageContext.request.contextPath}/static/images/1111.jpg) no-repeat center 0;
    }

    #banner .bd .bn4 {
        background: url(${pageContext.request.contextPath}/static/images/bg.jpg) no-repeat center 0;
    }

    #banner .bd .bn5 {
        background: url(${pageContext.request.contextPath}/static/images/best20180103.jpg) no-repeat center 0;
    }

    #banner .bd .bn6 {
        background: url(${pageContext.request.contextPath}/static/images/best20170310.jpg) no-repeat center 0;
    }

    #banner .bd .bn7 {
        background: url(${pageContext.request.contextPath}/static/images/best360zn.jpg) no-repeat center 0;
    }

    #banner .bd .bn88 {
        background: url(${pageContext.request.contextPath}/static/images/ucargo.jpg) no-repeat center 0;
    }

    #banner .bd .bn9 {
        background: url(${pageContext.request.contextPath}/static/images/best0212.jpg) no-repeat center 0;
    }

    #banner .bd .bn90 {
        background: url(${pageContext.request.contextPath}/static/images/0810.jpg) no-repeat center 0;
    }
</style>
    ...
    <div class="header-top">
        <div class="w980 clearfix">
            ...
            <div class="right">
                ...
                <a href="${pageContext.request.contextPath}/static//best/contact.shtml" class="brno"
                   style="display:none;">联系我们</a>
                    ...
                    <ul id="navslide">
                        ...
                        <li class="mcat m1">
                            ...
                            <div class="scat scat_top">
                                <ul>
                                    <li><a href="${pageContext.request.contextPath}/static//freight/track.asp">快运</a>
                                    </li>
                        ...
                        <li class="mcat m2">
                            ...
                            <div class="scat">
                                <ul>
                                    <li><a href="./3" target="_blank">快递</a></li>
                        ...
                        <li class="mcat m3">
                            ...
                            <div class="scat">
                                <ul>
                                    <li><a href="${pageContext.request.contextPath}/static//supply-chain/network.shtml">供应链</a>
                                    </li>
                                    <li>
                                        <a href="${pageContext.request.contextPath}/static//freight/network.shtml">快运</a>
                                    </li>
                ...
                <ul class="clearfix">
                    ...
                    <li class="nli">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="http://www.800best.com/express/partner/" target="_blank">·&nbsp;&nbsp;在线加盟</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nli">
        ...
        <div id="banner">
            ...
            <div class="bd">
                <ul class="clearfix">
                    ...
                    <li class="bn5"><a href="http://www.800bestex.com/news/detail/E2A36DBF2AA5AB0B" target="_blank"></a>
                    </li>
    ...
    <div class="w980 mbox">
        ...
        <div class="item news clearfix">
            ...
            <div class="news-list">
                <ul>
                    <li class='clearfix'>
                        <div class='pic'><a href='/news/493.shtml'><img
                                src='${pageContext.request.contextPath}/static/picture/060107.png'
                                onerror='this.src="${pageContext.request.contextPath}/static//img/news_no.jpg"'/></a>
                        </div>
                        <div class='txt'><h2><a href='/news/493.shtml' title='中国物流与采购网：“新玩家”的运筹帷幄！火箭国际以智慧供应链服务跨境电商'>中国物流与采购网：“新玩家”的运筹帷幄！</a>
                        </h2>

                            <p>火箭国际针对美国市场推出了海运FBA拼箱及整柜直送服务以及空运FBA专线，并提供...</p></div>
                    </li>
                    <li class='clearfix'>
                        <div class='pic'><a href='/news/492.shtml'><img
                                src='${pageContext.request.contextPath}/static/picture/060103.jpg'
                                onerror='this.src="${pageContext.request.contextPath}/static/img/news_no.jpg"'/></a>
                        </div>
                        <div class='txt'><h2><a href='/news/492.shtml' title='中国网：以供应链赋能新零售 火箭店加有新解'>中国网：以供应链赋能新零售
                            火箭店加有新</a></h2>

                            <p>中国报道讯 （杨金鑫报道）在最新发布的《2018中国便利店发展报告》（以下简称“...</p></div>
                    </li>
...
<div class="footer">
    ...
    <div class="w980 clearfix mt14">
            ...
            <ul class="clearfix">
                ...
                <li class="mlist">
                    ...
                    <ul class="slist">
                        ...
                        <li><a href="http://weibo.com/u/5596286925?refer_flag=1001030101_&is_hot=1"
                               target="_blank">快运微博</a></li>
                    </ul>
                </li>
                <li class="mlist last">
        ...
        <div class="contact clearfix">
            <div class="left" style="display:none;"><img src="${pageContext.request.contextPath}/static/picture/wx.jpg"
                                                         alt=""/></div>
    ...
    <div class="w980 clearfix mt44">
        <div class="auth">
            <a style="display:none;"
               href="http://122.224.75.236/wzba/login.do?method=hdurl&doamin=http://www.800best.com&id=330108000004538&SHID=1223.0AFF_NAME=com.rouger.gs.main.UserInfoAff&AFF_ACTION=qyhzdetail&PAGE_URL=ShowDetail"
               target="_blank"><img src="${pageContext.request.contextPath}/static/picture/gh.jpg" alt=""/></a>&nbsp;&nbsp;
            <a href="http://www.moc.gov.cn/" target="_blank"><img
                    src="${pageContext.request.contextPath}/static/picture/fc2.jpg" alt=""/></a>&nbsp;&nbsp;
            <a style="display:none;" href="http://www.chinawuliu.com.cn/" target="_blank"><img
                    src="${pageContext.request.contextPath}/static/picture/fc3.jpg" alt=""/></a>

            <div style="position:absolute;margin:-53px 0 0 200px;width:300px;padding:20px 0;"><a target="_blank"
                                                                                                 href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010602000848"
                                                                                                 style="display:inline-block;text-decoration:none;height:20px;line-height:20px;"><img
                    src="${pageContext.request.contextPath}/static/picture/ghs.png" style="float:left;"/>

                <p style="float:left;height:20px;line-height:20px;margin: 0px 0px 0px 5px; color:#939393;">浙公网安备
                    33010602000848号</p></a></div>
        </div>
        <div class="copy">
