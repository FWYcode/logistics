...
<div class="topnav">
    <div class="container clearfix">
        <img onclick="window.open('http://webcs.800best.com/smWeb.html', 'webcs', 'width=750,height=600,toolbar=no, menubar=no, scrollbars=no, resizable=yes,location=no, status=no,center=yes');"
             src="picture/minionlinesevice.png" style="position:absolute;right:0;top:0;cursor:pointer"/>
...
<div class="modal hide fade alipay-box p20" id="alipay-box" style="text-align: center;width:360px;margin-left:-240px;">
    <img src="${pageContext.request.contextPath}/static/picture/alipay_qr.jpg"/>
    ...
    <div class="container">
        ...
        <div class="box send-box row">
            <div class="span span9 web-order">
                ...
                <form action="/Order/Result" class="form-horizontal mt10" id="send-form" method="post">
                    <fieldset class="send-container">
                        ...
                        <div class="control-group">
                            ...
                            <label class="control-label" for="fromname"><span class="font-red">*</span> 姓名</label>

                            <div class="controls">
                                <input type="text" class="input-medium name-input " id="fromname" name="fromname">
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-medium name-input layui-form-label" id="fromphone" name="fromphone">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <label class="control-label">
                                <span class="font-red">*</span> 上门地址</label>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <input type="text" class="input-xlarge span5" name="fromaddress"
                                       placeholder="详细地址（街道门牌信息）" lay-filter="area">
                            </div>
                        </div>
                    </fieldset>
                    <fieldset class="receive-container">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-medium name-input" name="toname" lay-filter="area">
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="input-medium name-input" name="tophone" lay-filter="area">
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="district-input-wrap">
                                    <input type="text" readonly class="input-xlarge district-input" id="todistrict"
                                           placeholder="输入城市名（中文/拼音首字母）"/>
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select class="input-medium" name="weight">
                                    <option> 1公斤以下</option>
                                    <option> 1-5公斤</option>
                                    <option> 5公斤以上</option>
                                </select>
            ...
            <div class="onlineSever seviceSize">
                <a class="seviceSize" href="javascript:void(0);"
                   onclick="window.open('http://webcs.800best.com/smWeb.html', 'webcs', 'width=750,height=600,toolbar=no, menubar=no, scrollbars=no, resizable=yes,location=no, status=no,center=yes');">
                    <img src="picture/onlinesevice.png" alt=""/>
                </a>
            ...
            <div class="span span3">
                ...
                <p class="text-center">
                    ...
                    <%--<img src="${pageContext.request.contextPath}/static/picture/wxxcxcreateorder.jpg" alt="小程序二维码">--%>
                    <br>
                    <%--<span class="font16">微信扫一扫</span>--%>

                    <%--<img style="margin-top: 15px" src="${pageContext.request.contextPath}/static/picture/alipay_qr.jpg" alt="支付宝二维码">--%>
                    <br>
            ...
            <div class="span wx-span" style="float:right">
                ...
                <div class="row mt30">
                    ...
                    <div class="span text-center" style="float: right">
                        <div>
                            <img src="picture/rcewm.png" alt="火箭招聘">
                        </div>
        ...
        <div class="copy row">
            ...
            <%--<div class="span span3 text-right">--%>
                <%--火箭快递微博：<a href="http://e.weibo.com/bestexpress" target="_blank" title="访问火箭快递官方微博"><img--%>
                    <%--src="picture/f3.png" alt="访问火箭快递官方微博"></a>--%>
            <%--</div>--%>
        </div>
        <div class="text-center">
            ...
            <%--<a style="color:#939393;text-decoration: underline" target="_blank" href="${pageContext.request.contextPath}/static/images/yyzz.jpg">企业营业执照</a>--%>
        </div>
    </div>
</div>
</body>